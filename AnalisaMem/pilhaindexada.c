...
// Descricao: empilha o endereÃ§o e com informacao in
// Entrada: p, e e in
// Saida: p
{
  int distpilha = 1;
  ...
  if (elemidxempty(&(p->pilha[e]))){
    ...
    // serve para identificar os casos onde sÃ³ tem o topo na pilha
    p->pilha[e].ant = e;
    // atualiza info
    endinfoidxcopia(in,&(p->pilha[e].info));
    // verifica se Ã© a primeira insercao
    ...
    long aux,ant,prox;
    // nÃ£o Ã© o primeiro acesso
    // calcula a distÃ¢ncia de pilha.
...
// Descricao: desempilha o topo da pilha, que Ã© colocado em "e" e "o"
// Entrada: p
// Saida: "e" e "o"
{
