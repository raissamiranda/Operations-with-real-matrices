...
// assumimos o que o tamanho da palavra de mÃ¡quina Ã© 64 bits (8 bytes)
...
// Descricao: divide a linha em tokens separados por espaÃ§o
// Entrada: line
// Saida: tkvet
{
  char *token;
  char *saveptr1;
  // tokens delimitados por espaÃ§os em branco
  char delim[2] = " ";
  int j;
...
// Saida: 
{
  ...
  // determina o nÃºmero de fases e de identificadores de variaveis
  ...
  // cria pilha e vetor de contagem de distÃ¢ncia de pilha, um por fase.
